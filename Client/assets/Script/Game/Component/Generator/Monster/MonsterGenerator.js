...
cc.Class({
    ...
    start () {
        ...
        // 相对速度
        this.relativeSpeed = 1700;
        // 相对速度范围
        this.relativeSpeedRange = 1200;
        // 相对速度衰减值
        ...
        if (this.cfgName == "MFlyConfig") {
            this.initWithConfig(MonsterConfig.getDataByLevel(this.cfgName , 0));    
        }
        else
        {
    ...
    initWithConfig:function (cfg) {
        ...
        console.log(this.cfgName);
        console.log(cfg);

        if (this.cfgName != "MClipConfig") {
