...
cc.Class({
    ...
    start () {
        ...
        this.max = Global.Model.MFlyCoins.getAttr().maxNum;
        this.interval = Global.Model.MFlyCoins.getAttr().interval;
        this.generateRate = Global.Model.MFlyCoins.getAttr().rate;
    },
