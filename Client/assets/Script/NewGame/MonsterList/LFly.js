...
cc.Class({
    ...
    start () {
        ...
        this.max = Global.Model.MFly.getAttr().maxNum;
        this.interval = Global.Model.MFly.getAttr().interval;
        this.generateRate = Global.Model.MFly.getAttr().rate;
    },
    ...
    generateMonster:function (parent , maxNum , origin , range) {
        ...
        for (let index = 0; index < len; index++) {
            ...
            else
            {
                ...
                monster.name = "MFly" + this._GeneratedMonsterID;
                monster.x = posx;
                monster.y += Global.Common.Utils.random(0 , 800);
