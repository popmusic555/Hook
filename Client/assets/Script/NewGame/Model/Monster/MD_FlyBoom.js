 ...
 * 普通怪物数据初始化
 */
MFlyBoom.init = function () {
    // 类型
    this.type = Enum.TYPE.BOOM_FLY;
    // 怪物属性
    this.attr = {};
    // 弹性
    this.attr.elastic = 0;
...
MFlyBoom.updateByPass = function (passID) {
    ...
    var cfg = Global.Model.Game.getConfigByLevel(Global.Model.Game.levelsItemConfig.flyboom , level);
 ...
 */
MFlyBoom.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MFlyBoom.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MFlyBoom.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MFlyBoom.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MFlyBoom.limitVelocityY = function (y) {
