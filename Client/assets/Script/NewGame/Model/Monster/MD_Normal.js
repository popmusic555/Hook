 ...
 */
MNormal.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MNormal.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MNormal.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MNormal.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MNormal.limitVelocityY = function (y) {
