...
MBoom.setConfig = function (config) {
    this.config = config;
};
 ...
 */
MBoom.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MBoom.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MBoom.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MBoom.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MBoom.limitVelocityY = function (y) {
