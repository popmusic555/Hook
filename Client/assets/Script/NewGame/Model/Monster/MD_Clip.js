...
MClip.setConfig = function (config) {
    this.config = config;
};
 ...
 */
MClip.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MClip.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MClip.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MClip.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MClip.limitVelocityY = function (y) {
