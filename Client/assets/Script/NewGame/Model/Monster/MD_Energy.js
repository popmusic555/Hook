 ...
 * 普通怪物数据初始化
 */
MEnergy.init = function () {
    // 类型
    this.type = Enum.TYPE.ENERGY;
    // 怪物属性
    this.attr = {};
    // 弹性
    this.attr.elastic = 0;
 ...
 */
MEnergy.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MEnergy.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MEnergy.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MEnergy.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MEnergy.limitVelocityY = function (y) {
