...
MPlane.setConfig = function (config) {
    this.config = config;
};
 ...
 */
MPlane.handleCollision = function (contact , selfCollider , otherCollider) {
 ...
 */
MPlane.collisionFloor = function (contact , monsterCollider , floorCollider) {
 ...
 */
MPlane.collisionWall = function (contact , monsterCollider , wallCollider) {
    var monster = monsterCollider.node.getComponent(Global.GameObj.GBase);
 ...
 * @param {any} x 速度值
 */
MPlane.limitVelocityX = function (x) {
 ...
 * @param {any} y 速度值
 */
MPlane.limitVelocityY = function (y) {
